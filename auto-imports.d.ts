...
export {}
declare global {
  const CAxios: typeof import('./src/utils/request/axios')['CAxios']
  ...
  const config: typeof import('./src/store/useTabBarStore/config')['default']
  const createProxy: typeof import('./src/utils/dotenv')['createProxy']
  const createRef: typeof import('react')['createRef']
  const deepMerge: typeof import('./src/utils/index')['deepMerge']
  const forwardRef: typeof import('react')['forwardRef']
  const lazy: typeof import('react')['lazy']
  const loadEnv: typeof import('./src/utils/dotenv')['loadEnv']
  const memo: typeof import('react')['memo']
  const mergeClassName: typeof import('./src/utils/index')['mergeClassName']
  const request: typeof import('./src/utils/request/index')['default']
  ...
  const useTabBarStore: typeof import('./src/store/useTabBarStore/index')['default']
